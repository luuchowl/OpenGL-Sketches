...
void main()
{
    ...
    color = vec3(1.0);
    color.r = line(dist + l * 0.03 * saturate(sin((a * 1.0) + u_time * mult)), plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.02, 0.01);
    color.g = line(dist + l * 0.01 * saturate(sin((a * 1.0 + 0.4) + u_time * mult)),plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.02, 0.01);
    //color.b = line(dist + l * 0.02 * saturate(sin((a * 1.0 + 0.5) + u_time * mult)), plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.01, 0.01);

    plot = 0.3;
    color.r *= line(dist + l * 0.005 * saturate(sin((a * 1.0) + u_time * mult)), plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.02, 0.001);
    color.g *= line(dist + l * 0.002 * saturate(sin((a * 1.0 + 0.4) + u_time * mult)),plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.02, 0.003);
    color.b *= line(dist + l * 0.003 * saturate(sin((a * 1.0 + 0.5) + u_time * mult)), plot, saturate(sin((a * 1.0 + 0.4) + u_time * mult)) * 0.01, 0.004);
